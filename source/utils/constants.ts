...
export const XPATH_FOLLOWED_LIST = '//*[@id="sideNav"]//div[contains(@class, "tw-transition-group")]'

// Place where the Favorite button will be placed.
export const XPATH_TARGET_BUTTON_LOCATION = '//*[@class="metadata-layout__secondary-button-spacing"]'
